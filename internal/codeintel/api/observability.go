...
func (api *ObservedCodeIntelAPI) Diagnostics(ctx context.Context, file string, uploadID int) (diagnostics []bundles.Diagnostic, err error) {
	...
	return api.codeIntelAPI.Diagnostics(ctx, file, uploadID)
}
